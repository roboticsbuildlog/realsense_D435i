...
###############################################
#supported resolution modes:    1280, 800   fps 30
#                               1280, 720   fps 30
#                               848, 480    fps 90
#                               640, 480    fps 90
#                               640, 400    fps 25
...
try:
    while True:
        ...
        infrared_image = np.asanyarray(ir1_frame.get_data())
        ...
        cv2.imshow('IR', infrared_image)


        k = cv2.waitKey(1) & 0xFF #Exit with ESC key
        if k == 27:
            break
